...
module Cocina
  module Models
    class AdminPolicyAccessTemplate < Struct
      attribute :view,
                Types::Strict::String.enum('world', 'stanford', 'location-based', 'citation-only',
                                           'dark').meta(omittable: true)
      ...
      attribute :download,
                Types::Strict::String.enum('world', 'stanford', 'location-based', 'none').meta(omittable: true)
      ...
      attribute :location,
                Types::Strict::String.optional.enum('spec', 'music', 'ars', 'art', 'hoover',
                                                    'm&m').meta(omittable: true)
