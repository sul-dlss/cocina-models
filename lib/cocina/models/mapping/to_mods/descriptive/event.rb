        ...
        class Descriptive
          ...
          class Event # rubocop:disable Metrics/ClassLength
            ...
            def date_element_name(date, cocina_event_type, structured_val_type)
              el_name = Cocina::Models::Mapping::FromMods::Descriptive::Event::DATE_ELEMENTS_2_TYPE.key(structured_val_type)
              return el_name if el_name.present?

              el_name = Cocina::Models::Mapping::FromMods::Descriptive::Event::DATE_ELEMENTS_2_TYPE.key(date.type)
              return el_name if el_name.present?
              ...
              if cocina_event_type.present?
                el_name = Cocina::Models::Mapping::FromMods::Descriptive::Event::DATE_ELEMENTS_2_TYPE.key(cocina_event_type)
                return el_name if el_name.present?
              end
