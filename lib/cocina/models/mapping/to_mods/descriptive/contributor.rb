      ...
      module ToMods
        class Descriptive
          ...
          class Contributor
            ...
            NAME_TYPE = Cocina::Models::Mapping::FromMods::Descriptive::Contributor::ROLES.invert.merge('event' => 'corporate').freeze
            NAME_PART = Cocina::Models::Mapping::FromMods::Descriptive::Contributor::NAME_PART.invert.freeze
