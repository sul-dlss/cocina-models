          ...
          class Subject
            ...
            def write
              subjects.each do |subject|
                ...
                if parallel_subject_values.present? && Cocina::Models::Mapping::FromMods::Descriptive::Contributor::ROLES.value?(subject.type)
            ...
            def write_structured_or_grouped(subject, subject_value, alt_rep_group: nil, type: nil, display_values: nil)
              ...
              xml.subject(structured_attributes_for(subject_value, type, alt_rep_group: alt_rep_group)) do
                if type == 'place' && subject_value.structuredValue.present?
                ...
                elsif Cocina::Models::Mapping::FromMods::Descriptive::Contributor::ROLES.value?(type)
                  ...
                  values.each do |value|
                    if Cocina::Models::Mapping::FromMods::Descriptive::Contributor::ROLES.value?(value.type)
            ...
            def write_basic(subject, subject_value, alt_rep_group: nil, type: nil, display_values: nil)
              ...
              elsif Cocina::Models::Mapping::FromMods::Descriptive::Contributor::ROLES.value?(type) || type == 'name'
            ...
            def name_type_for(type)
              Cocina::Models::Mapping::FromMods::Descriptive::Contributor::ROLES.invert[type]
            end
