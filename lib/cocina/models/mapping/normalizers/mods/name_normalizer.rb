          ...
          class NameNormalizer # rubocop:disable Metrics/ClassLength
            ...
            def normalize_type
              ng_xml.root.xpath('//mods:name[@type]', mods: ModsNormalizer::MODS_NS).each do |name_node_w_type|
                ...
                next if Cocina::Models::Mapping::FromMods::Descriptive::Contributor::ROLES.key?(raw_type)

                if Cocina::Models::Mapping::FromMods::Descriptive::Contributor::ROLES.key?(raw_type.downcase)
            ...
            def normalize_name_part_type
              ng_xml.root.xpath('//mods:namePart[(@type)]', mods: ModsNormalizer::MODS_NS).each do |name_part_node|
                ...
                next if Cocina::Models::Mapping::FromMods::Descriptive::Contributor::NAME_PART.key?(raw_type)
