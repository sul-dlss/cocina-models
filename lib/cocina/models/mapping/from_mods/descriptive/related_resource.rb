      ...
      module FromMods
        class Descriptive
          ...
          class RelatedResource
            TYPES = Cocina::Models::Mapping::ToMods::Descriptive::RelatedResource::TYPES.invert.freeze
            DETAIL_TYPES = Cocina::Models::Mapping::ToMods::Descriptive::RelatedResource::DETAIL_TYPES.invert.freeze
