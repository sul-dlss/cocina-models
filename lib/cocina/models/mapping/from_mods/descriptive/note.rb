      ...
      module FromMods
        class Descriptive
          ...
          class Note # rubocop:disable Metrics/ClassLength
            ...
            # @param [Cocina::Models::Mapping::FromMods::Descriptive::DescriptiveBuilder] descriptive_builder (not used, but passed in by DescriptiveBuilder)
            ...
            def note_type(node)
              return node['type'].downcase if Cocina::Models::Mapping::ToMods::Descriptive::Note.note_type_to_abstract_type.include?(node['type']&.downcase)
            ...
            def abstract_type(node, parallel: false)
              ...
              elsif Cocina::Models::Mapping::ToMods::Descriptive::Note.display_label_to_abstract_type.exclude?(node['displayLabel']) && !parallel
                { type: 'abstract' }
              else
                {}
              end
