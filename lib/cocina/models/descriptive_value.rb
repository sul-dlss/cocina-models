  ...
  module Models
    class DescriptiveValue < Struct
      ...
      def method_missing(method_name, *arguments, &block)
        if %i[structuredValue parallelValue groupedValue displayLabel valueLanguage valueAt
              appliesTo].include?(method_name)
          Deprecation.warn(
            self,
      ...
      def respond_to_missing?(method_name, include_private = false)
        %i[structuredValue parallelValue groupedValue displayLabel valueLanguage valueAt
