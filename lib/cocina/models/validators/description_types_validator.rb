    ...
    module Validators
      ...
      class DescriptionTypesValidator
        ...
        def match?(path, type_signature)
          ...
          end.last(type_signature.length) == type_signature
        end
        ...
        def types_yaml
          YAML.load_file(::File.expand_path('../../../../description_types.yml', __dir__)).merge(
            YAML.load_file(::File.expand_path('../../../../description_identifier_types.yml', __dir__))
          )
        end
